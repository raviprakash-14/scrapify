...
type ScrapType = 'metal-scrap' | 'e-waste';
...
export default function EstimatePage() {
  ...
  const [scrapType, setScrapType] = useState<ScrapType>('metal-scrap');
      ...
      <AnimatePresence mode="wait">
        {step === 'form' && (
          ...
          >
            <Card>
              <CardHeader>
                <CardTitle>Estimate Your Scrap</CardTitle>
                <CardDescription>
                  Provide a photo and description of your scrap to get an AI-powered value estimation.
                </CardDescription>
              </CardHeader>
              <form onSubmit={handleSubmit}>
                <CardContent className="space-y-6">
                    <Tabs value={scrapType} onValueChange={(value) => setScrapType(value as ScrapType)} className="w-full">
                        <TabsList className="grid w-full grid-cols-2">
                            <TabsTrigger value="metal-scrap"><Trash2 className="mr-2 h-4 w-4"/>Metal Scrap</TabsTrigger>
                            <TabsTrigger value="e-waste"><HardDrive className="mr-2 h-4 w-4"/>E-Waste</TabsTrigger>
                        </TabsList>
                    </Tabs>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="description"
                      placeholder={scrapType === 'e-waste' ? "e.g., Old Dell laptop, broken screen" : "e.g., Old copper pipes, approximately 10 feet long"}
                      value={description}
